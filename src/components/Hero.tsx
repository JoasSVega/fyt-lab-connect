      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="block text-transparent bg-gradient-to-r from-fyt-blue to-fyt-purple bg-clip-text">GIFYT</span>
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            return <Card key={index} className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-all duration-300 cursor-pointer group shadow-large" onClick={() => scrollToSection(action.href)}>
                  <div className="p-6 text-center">
                    <div className={`w-12 h-12 mx-auto mb-4 rounded-full flex items-center justify-center ${action.color === 'primary' ? 'bg-fyt-blue' : action.color === 'secondary' ? 'bg-fyt-purple' : 'bg-fyt-red'}`}>
