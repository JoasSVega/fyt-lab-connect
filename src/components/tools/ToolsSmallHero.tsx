...
const ToolsSmallHero: React.FC<ToolsSmallHeroProps> = ({ title, subtitle }) => {
  return (
    <section className="relative bg-gradient-to-br from-blue-900 via-cyan-900 to-blue-900 py-16 md:py-20 lg:py-24">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
        <div className="flex justify-center mb-4">
          <div className="p-3 bg-cyan-500/20 rounded-full">
            <Wrench className="w-8 h-8 text-cyan-300" aria-hidden="true" />
          </div>
        </div>
