        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-16 items-start">
          ...
          <div className="flex flex-col min-w-[220px] col-span-1">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#0f172a] tracking-wide" style={{ fontFamily: 'Poppins, Inter, Montserrat, sans-serif' }}>
                  Grupo FyT
                </h3>
          ...
          <div className="flex flex-col items-start gap-3 col-span-1">
            <h4 className="text-lg font-raleway font-bold mb-2 text-[#0f172a]">Contacto</h4>
            <div className="flex items-center gap-2 text-sm text-[#0f172a]">
              <Phone className="w-5 h-5 text-[#9B59B6] flex-shrink-0" aria-label="Teléfono" />
              <span>+57 313 7375217</span>
            </div>

            <div className="flex items-center gap-2 text-sm text-[#0f172a]">
              <Mail className="w-5 h-5 text-[#3BB9FF] flex-shrink-0" aria-label="Correo electrónico" />
              <span className="text-[#0f172a]">farmacologiayterapeutica.gi@gmail.com</span>
            </div>

            <div className="flex items-start gap-2 text-sm text-[#0f172a]">
              <MapPin className="w-5 h-5 text-[#FF4C4C] flex-shrink-0 mt-0.5" aria-label="Dirección" />
          ...
          <div className="flex flex-col items-start gap-3 col-span-1">
            <h4 className="text-lg font-raleway font-bold mb-2 text-[#0f172a]">Enlaces Institucionales</h4>
            <button onClick={() => openExternal('https://www.unicartagena.edu.co/')} className="text-sm text-[#0f172a] hover:text-[#3BB9FF] p-0 h-auto min-w-[120px] text-left font-inter">
              Universidad de Cartagena
              <ExternalLink className="h-3 w-3 ml-1 inline-block" />
            </button>
            <button onClick={() => openExternal('https://www.unicartagena.edu.co/estudia-con-nosotros?view=search&resetSearch=1&preserve=1&geo-latitude=&geo-longitude=&geo-country=&location-detected=&geolocation=&categorySuggestion=&suggestionType=&categorySearch=250')} className="text-sm text-[#0f172a] hover:text-[#3BB9FF] p-0 h-auto min-w-[120px] text-left font-inter">
              Facultad de Ciencias Farmacéuticas
              <ExternalLink className="h-3 w-3 ml-1 inline-block" />
            </button>
            <button onClick={() => openExternal('https://scienti.minciencias.gov.co/gruplac/jsp/visualiza/visualizagr.jsp?nro=00000000008618')} className="text-sm text-[#0f172a] hover:text-[#3BB9FF] p-0 h-auto min-w-[120px] text-left font-inter">
              MinCiencias
              <ExternalLink className="h-3 w-3 ml-1 inline-block" />
            </button>
          </div>
          ...
          {/* 4. Síguenos (icono) */}
          <div className="flex flex-col items-start gap-3 col-span-1">
            <h4 className="text-lg font-raleway font-bold mb-2 text-[#0f172a]">Síguenos</h4>
            <div className="flex items-center gap-3">
              <button onClick={() => openExternal('https://www.instagram.com/grupo_fyt?igsh=MXNxbXo3eHM2MHRweA==')} aria-label="Instagram Grupo FyT" className="p-2 rounded-full text-[#0f172a] hover:text-pink-400 hover:bg-gray-100 transition-colors">
      ...
      <div className="border-t border-slate-200/60">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4 text-xs sm:text-sm text-[#64748b]">
            ...
            <div className="flex flex-row gap-3 md:gap-6 w-full md:w-auto items-center justify-end">
              <a href="/PrivacyPolicy" className="hover:text-[#3BB9FF] transition-colors text-left md:text-center" aria-label="Política de Privacidad">Política de Privacidad</a>
              <a href="/TermsOfUse" className="hover:text-[#9B59B6] transition-colors text-left md:text-center" aria-label="Términos de Uso">Términos de Uso</a>
              <a href="/CodeOfEthics" className="hover:text-[#FF4C4C] transition-colors text-left md:text-center" aria-label="Código de Ética">Código de Ética</a>
            </div>
          </div>

          <div className="w-full flex justify-start mt-2">
            <a href="https://www.linkedin.com/in/joassvega" target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm text-[#64748b] hover:text-[#3BB9FF] transition-colors flex items-center gap-1">
