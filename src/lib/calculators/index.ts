...
export const CalculatorsRegistry = {
  ...
  bmr: {
    ...
    fields: [
      { name: "weight", label: "Peso", type: "number", unit: "kg", placeholder: "p. ej., 70", validation: { required: true, min: 20, max: 300 } },
      { name: "height", label: "Talla", type: "number", unit: "cm", placeholder: "p. ej., 175", validation: { required: true, min: 100, max: 250 } },
      { name: "age", label: "Edad", type: "number", unit: "años", placeholder: "p. ej., 40", validation: { required: true, min: 5, max: 120 } },
      { name: "sex", label: "Sexo", type: "select", options: [ { value: "male", label: "Masculino" }, { value: "female", label: "Femenino" } ], placeholder: "Seleccionar", validation: { required: true } },
    ],
    formulas: [
  ...
  hepatic: {
    ...
    fields: [
      { name: "bili", label: "Bilirrubina total", type: "number", unit: "mg/dL o µmol/L", placeholder: "p. ej., 1.2" },
      { name: "biliUnit", label: "Unidad de bilirrubina", type: "select", options: [ { value: "mgdl", label: "mg/dL" }, { value: "umol", label: "µmol/L" } ], placeholder: "Seleccionar" },
      { name: "albumin", label: "Albúmina", type: "number", unit: "g/dL", placeholder: "p. ej., 3.8" },
      { name: "inr", label: "INR", type: "number", placeholder: "p. ej., 1.2" },
      { name: "ascites", label: "Ascitis", type: "select", options: [ { value: "none", label: "Ausente" }, { value: "mild", label: "Leve o controlada" }, { value: "moderate", label: "Moderada" }, { value: "severe", label: "Severa" } ] },
      { name: "enceph", label: "Encefalopatía", type: "select", options: [ { value: "none", label: "Ausente" }, { value: "mild", label: "Grado I–II" }, { value: "moderate", label: "Grado III" }, { value: "severe", label: "Grado IV" } ] },
      { name: "creat", label: "Creatinina", type: "number", unit: "mg/dL", placeholder: "p. ej., 1.0" },
      { name: "sodium", label: "Sodio sérico (opcional)", type: "number", unit: "mmol/L", placeholder: "p. ej., 135" },
      { name: "ast", label: "AST", type: "number", unit: "UI/L", placeholder: "p. ej., 35" },
      { name: "alt", label: "ALT", type: "number", unit: "UI/L", placeholder: "p. ej., 40" },
      { name: "astULN", label: "LSN AST", type: "number", unit: "UI/L", placeholder: "p. ej., 40" },
      { name: "platelets", label: "Plaquetas", type: "number", unit: "10^9/L", placeholder: "p. ej., 250" },
      { name: "age", label: "Edad", type: "number", unit: "años", placeholder: "p. ej., 50" },
    ],
    formulas: [
  ...
  { id: "meld", label: "MELD / MELD‑Na", description: "Modelo de enfermedad hepática terminal", expressionLatex: String.raw`\mathrm{MELD}=3.78\ln(\text{bili})+11.2\ln(\text{INR})+9.57\ln(\text{creat})+6.43\\ \mathrm{MELD\mbox{-}Na}=\mathrm{MELD}+1.59\,(135-\text{Na})`, compute: computeMELD, fields: [
        { name: "inr", label: "INR", type: "number", placeholder: "p. ej., 1.2" },
        { name: "bili", label: "Bilirrubina total", type: "number", unit: "mg/dL", placeholder: "p. ej., 1.2" },
        { name: "creat", label: "Creatinina", type: "number", unit: "mg/dL", placeholder: "p. ej., 1.0" },
        { name: "sodium", label: "Sodio sérico (opcional)", type: "number", unit: "mmol/L", placeholder: "p. ej., 135" },
      ] },
  ...
  reconstitution: {
    ...
    color: "#64748B",
    fields: [
      { name: "abId", label: "Antibiótico", type: "select", options: (antibiotics as Array<{id:string; name:string}>).map((a) => ({ value: a.id, label: a.name })), placeholder: "Seleccionar" },
      { name: "reconstMl", label: "Volumen de reconstitución", type: "number", unit: "mL", placeholder: "p. ej., 10", validation: { min: 0 } },
      { name: "dose", label: "Dosis a administrar", type: "number", placeholder: "p. ej., 1000" },
      { name: "doseUnit", label: "Unidad de dosis", type: "select", options: [ { value: "mg", label: "mg" }, { value: "g", label: "g" } ], placeholder: "Seleccionar" },
      { name: "desiredConc", label: "Concentración final (opcional)", type: "number", unit: "mg/mL", placeholder: "p. ej., 2.0" },
      { name: "finalVolume", label: "Volumen final (opcional)", type: "number", unit: "mL", placeholder: "p. ej., 100" },
