...
export const divulgacionPosts: DivulgacionPost[] = [
  {
    ...
    title: "La actualización de los códigos CUPS: un paso inapelable hacia la visibilidad de la profesión Químico Farmacéutica en la atención farmacéutica colombiana",
    excerpt: "La actualización y apropiación de los códigos CUPS representa una necesidad imperativa para otorgar visibilidad real a la profesión Químico Farmacéutica desde el ámbito de la atención farmacéutica, mejorando la seguridad del paciente y permitiendo la trazabilidad de las intervenciones clínicas.",
    ...
    content: `
<p>En el sistema de salud colombiano, la <strong>Clasificación Única de Procedimientos en Salud</strong> (CUPS) constituye el eje sobre el cual se articula la atención; es el lenguaje técnico que permite que cada intervención sea registrada, medida y, por supuesto, financiada. Sin embargo, para el <strong>Químico Farmacéutico</strong>, esta estructura ha presentado históricamente un vacío que limita el reconocimiento de su rol asistencial. Por esta razón, la evolución de estos códigos no debe verse como un simple ajuste administrativo, sino como una <strong>necesidad imperativa para otorgar visibilidad real a la profesión</strong> desde el ámbito de la atención farmacéutica, lo que constituye un factor determinante en los procesos de seguridad del paciente.</p>

<h2>¿Qué son los códigos CUPS?</h2>

<p>Formalmente, el Artículo 4 de la <em>Resolución 4678 de 2015</em> define los CUPS como el sistema que <em>"corresponde al ordenamiento lógico y detallado de los procedimientos y servicios en salud que se realizan en el país, en cumplimiento de los principios de interoperabilidad y estandarización de datos"</em>. En la práctica, esto significa que cada procedimiento—desde una cirugía compleja hasta una consulta de control—recibe un código y una descripción únicos. Este sistema es esencial para <strong>estandarizar el registro de la atención, la facturación de servicios y el análisis de datos a nivel nacional</strong>, independientemente del profesional que realice el procedimiento. Sin embargo, aunque este modelo funciona adecuadamente para la mayoría de las áreas, presenta una ambigüedad crítica respecto a los servicios clínicos farmacéuticos.</p>

<h2>La brecha de especificidad en la atención farmacéutica</h2>

<p>Teniendo en cuenta lo anterior, nos enfrentamos a <strong>una falta de especificidad que diluye la labor del Químico Farmacéutico colombiano</strong>. Al agrupar diversas actividades farmacéuticas en códigos genéricos, se genera un déficit de datos que impide al Ministerio de Salud y a los entes de control valorar el impacto real de nuestras intervenciones. La atención farmacéutica, por su propia naturaleza legal y técnica, no es un proceso de soporte logístico, sino un <strong>acto clínico autónomo</strong>. Cuando realizamos una entrevista farmacéutica, construimos el perfil farmacoterapéutico del paciente y detectamos problemas relacionados con los medicamentos, estamos ejecutando una actividad que es <strong>equivalente, en rigor y responsabilidad, a una consulta profesional</strong>—que además puede ser especializada dado el universo complejo de patologías que enfrentamos y el extenso arsenal terapéutico disponible, tanto farmacológico como no farmacológico.</p>

<h2>Códigos CUPS específicos: el camino hacia la integración interdisciplinaria</h2>

<p>Bajo esta premisa, la <strong>inclusión de códigos específicos para la interconsulta por Químico Farmacéutico y las consultas de seguimiento</strong> se convierte en el pilar para la integración definitiva del farmacéutico en el equipo interdisciplinario. Este reconocimiento permite que nuestra participación en la historia clínica deje de ser una nota marginal para convertirse en un <strong>procedimiento trazable y documentado</strong>. Es, en esencia, la herramienta que nos permite <strong>hablar el mismo idioma que otras disciplinas de la salud</strong>—como enfermería o nutrición—quienes ya cuentan con este respaldo en la codificación nacional para sus consultas especializadas.</p>

<h2>Impacto en la seguridad del paciente y la salud pública</h2>

<p>El beneficio de esta visibilidad impacta directamente en la <strong>seguridad de las poblaciones más vulnerables</strong>. En escenarios de alta complejidad—como el manejo de enfermedades huérfanas, la atención pediátrica o el control de la polifarmacia en adultos mayores—la intervención del Químico Farmacéutico reduce de manera comprobada la morbilidad y los reingresos hospitalarios. Al formalizar estos procedimientos mediante códigos CUPS diferenciados, el sistema finalmente podrá <strong>cuantificar cómo la gestión experta de la farmacoterapia salva vidas</strong> y optimiza los recursos públicos, demostrando la rentabilidad clínica y económica de la atención farmacéutica.</p>

<h2>Conclusión: una responsabilidad compartida</h2>

<p>En definitiva, <strong>actualizar los CUPS para reflejar la realidad de la atención farmacéutica es un acto de justicia profesional y de responsabilidad sanitaria</strong>. Solo a través de una codificación que reconozca nuestra autonomía clínica podremos asegurar que el papel del Químico Farmacéutico en Colombia sea valorado por su verdadero aporte: <strong>garantizar que cada tratamiento sea una herramienta de curación segura, efectiva y humana</strong>.</p>
    `
  },
