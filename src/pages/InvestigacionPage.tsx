...
const InvestigacionPage: React.FC = () => {
  ...
  <a href="/contactos" className="inline-block px-6 py-3 rounded-full bg-fyt-blue text-white border-2 border-fyt-blue font-inter font-semibold shadow btn-solid-interactive text-lg">Contactar al equipo</a>
      </section>
